...
UPDT_FILES="${CURR_YEAR}/${PAGE_ID}.html"
UPDT_FILES="${UPDT_FILES} index.html atom.xml archives/index.html"
UPDT_FILES="${UPDT_FILES} ${CURR_YEAR}/index.html"
if [[ -n "${BOOK_CAT}" ]]; then
